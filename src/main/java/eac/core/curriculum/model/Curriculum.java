package eac.core.curriculum.model;
...
public class Curriculum {
    ...
    public Date getcDeleteTime() {
        return cDeleteTime;
    }

    public void setcDeleteTime(Date cDeleteTime) {
        this.cDeleteTime = cDeleteTime;
    }

    public String getcEffective() {
        return cEffective;
    }

    public void setcEffective(String cEffective) {
        this.cEffective = cEffective == null ? null : cEffective.trim();
    }
